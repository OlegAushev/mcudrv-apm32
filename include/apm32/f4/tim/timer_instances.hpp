...
template<typename T>
struct is_32bit_timer : std::bool_constant<emb::same_as_any<T, tim2, tim5>> {};
...
struct has_4_channels
    : std::bool_constant<
          emb::same_as_any<T, tim1, tim2, tim3, tim4, tim5, tim8>> {};

template<typename T>
concept timer_with_4_channels = has_4_channels<T>::value;
